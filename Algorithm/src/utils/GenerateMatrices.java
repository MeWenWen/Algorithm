...
public class GenerateMatrices {
    ...
    private File commFile = new File("800-CommunicationTimeMatrix.txt");
    private File execFile = new File("800-ExecutionTimeMatrix.txt");
//    private File commFile = new File("400-CommunicationTimeMatrix.txt");
//    private File execFile = new File("400-ExecutionTimeMatrix.txt");
//    private File commFile = new File("200-CommunicationTimeMatrix.txt");
//    private File execFile = new File("200-ExecutionTimeMatrix.txt");
//    private File commFile = new File("100-CommunicationTimeMatrix.txt");
//    private File execFile = new File("100-ExecutionTimeMatrix.txt");
//    private File commFile = new File("50-CommunicationTimeMatrix.txt");
//    private File execFile = new File("50-ExecutionTimeMatrix.txt");

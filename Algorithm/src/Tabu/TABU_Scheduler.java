...
//import com.tabu.DatacenterBroker;
...
//    private static PSO PSOSchedularInstance;
    ...
    public static void main(String[] args) {
        Log.printLine("Starting TABU Scheduler...");
        ...
        for(int k=0;k<commMatrix.length;k++) {
			for(int l=0;l<commMatrix[0].length;l++) {
				etc[k][l]=commMatrix[k][l]+execMatrix[k][l];
			}
		}
...
//        tabu.bindUseTabu();
        ...
        try {
            ...
            Log.printLine(TABU_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
